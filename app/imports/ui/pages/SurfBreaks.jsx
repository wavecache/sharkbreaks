  ...
  renderPage() {
    ...
    return (
      <Container id='surfBreaks-page'>
        ...
        <Input id='filter-breaks' placeholder='' size='big' style={searchBarStyle} label='Filter' onChange={(surfBreaks) => this.filterSurfBreaks(surfBreaks.target.value, this.props.surfBreaks)}/>
        <CardGroup centered>
